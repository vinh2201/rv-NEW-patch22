...
public final class LogBufferManager {
    ...
    public static void saveLogsToUri(Context context, Uri uri) {
        ...
        try {
            ...
            String messageKey = "revanced_debug_export_logs_success";
            Utils.showToastLong(
                    Utils.getResourceIdentifier(ResourceType.STRING, messageKey) != 0
                            ? str(messageKey)
    ...
    public static void showLogDialog(Context context) {
        try {
            ...
            Pair<Dialog, LinearLayout> dialogPair = CustomDialog.create(
                    context,
                    str("revanced_debug_export_logs_title"),
                    null,
                    logViewer,
                    ...
                    str("revanced_debug_export_logs_clear"),
            ...
            searchBar.setHint(str("revanced_debug_logs_search_hint"));
            ...
            Button btnExport = CustomDialog.createButton(context, dialogPair.first,
                    str("revanced_debug_export_logs_file"),
