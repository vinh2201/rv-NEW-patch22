...
internal val BytecodePatchContext.ivsVideoAdMetadataHandlerMethod by gettingFirstMethodDeclarativelyOrNull {
    strings("twitch-trigger", "twitch-stitched-ad", "twitch-ad-quartile", "twitch-stream-source")
    parameterTypes("L", "Lorg/json/JSONObject;")
    returnType("V")
}
